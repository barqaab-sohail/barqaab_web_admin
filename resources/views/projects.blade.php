...
<body>
    <div class="body-inner">
                            ...
                            <nav class="navbar navbar-expand-lg navbar-dark p-0">
                                ...
                                <div class="logo col-lg-3 text-center text-lg-left mb-3 mb-md-5 mb-lg-0">
                                    <a class="d-block" href="index.html">
                                        <img loading="lazy" src="/project/images/barqaab_logo.png" alt="Constra">
                                    </a>
                                </div><!-- logo end -->
        ...
        <!--/ Header end -->
        <div id="banner-area" class="banner-area" style="background-image:url(/project/images/banner/banner1.jpg)">
                            ...
                            <div class="col-lg-4 col-md-6 shuffle-item"
                                ...
                                <div class="project-img-container">
                                    <a class="gallery-popup" href="/project/images/projects/project1.jpg">
                                        <img class="img-fluid" src="/project/images/projects/project1.jpg"
                                            alt="project-image">
                            ...
                            <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;healthcare&quot;]">
                                <div class="project-img-container">
                                    <a class="gallery-popup" href="/project/images/projects/project2.jpg">
                                        <img class="img-fluid" src="/project/images/projects/project2.jpg"
                                            alt="project-image">
                                        <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                                    </a>
                                    <div class="project-item-info">
                            ...
                            <div class="col-lg-4 col-md-6 shuffle-item"
                                ...
                                <div class="project-img-container">
                                    <a class="gallery-popup" href="/project/images/projects/project3.jpg">
                                        <img class="img-fluid" src="/project/images/projects/project3.jpg"
                                            alt="project-image">
                                        <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                                    </a>
                                    <div class="project-item-info">
                            ...
                            <div class="col-lg-4 col-md-6 shuffle-item"
                                ...
                                <div class="project-img-container">
                                    <a class="gallery-popup" href="/project/images/projects/project4.jpg">
                                        <img class="img-fluid" src="/project/images/projects/project4.jpg"
                                            alt="project-image">
                                        <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                                    </a>
                                    <div class="project-item-info">
                            ...
                            <div class="col-lg-4 col-md-6 shuffle-item"
                                ...
                                <div class="project-img-container">
                                    <a class="gallery-popup" href="/project/images/projects/project5.jpg">
                                        <img class="img-fluid" src="/project/images/projects/project5.jpg"
                                            alt="project-image">
                                        <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                                    </a>
                                    <div class="project-item-info">
                            ...
                            <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;residential&quot;]">
                                <div class="project-img-container">
                                    <a class="gallery-popup" href="/project/images/projects/project6.jpg">
                                        <img class="img-fluid" src="/project/images/projects/project6.jpg"
                                            alt="project-image">
                                        <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                                    </a>
                                    <div class="project-item-info">
                ...
                <div class="container">
                    <div class="row justify-content-between">
                        <div class="col-lg-4 col-md-6 footer-widget footer-about">
                            ...
                            <img loading="lazy" width="200px" class="footer-logo" src="/project/images/footer-logo.png"
                                alt="Constra">
